...
struct addressSearchView2: View {
        ...
        VStack{
            ...
            List {
                ...
                ForEach(resultsStore.searchResultsPool){ index in
                    RowView2(aResult: self.$resultsStore.searchResultsPool[index], searchedAddress: self.$searchedAddress, userSetLocation: self.$userSetLocation, modalIsActive: self.$modalIsActive, userviewCenter: self.$userviewCenter)
                }
